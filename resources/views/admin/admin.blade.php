				...
				<div class="card col-md-12 ">
					<div class="row">
						...
						<div class="contentCard contentCardStatus col-md-3 center">
							<p class="head-card">{{$order[0]->oStatus}}
							<input type="hidden" name="oID[]" id="oID[]" value="{{$order[0]->oID}}"><br>
							<a href="#" id="create" class="btn btn-success" style="margin-left: 35px; margin-top:8px;" >สร้างใบเสนอราคา</a></p>
						</div>
					</div>
				</div>
				@endif
